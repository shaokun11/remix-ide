export default async () => {
  return {
    ...
    "contracts/1_Storage.sol": (
      await import("raw-loader!./contracts/1_Storage.sol")
    ).default,
    // @ts-ignore
    "contracts/2_Owner.sol": (
      await import("raw-loader!./contracts/2_Owner.sol")
    ).default,
    // @ts-ignore
    "contracts/3_Ballot.sol": (
      await import("raw-loader!./contracts/3_Ballot.sol")
    ).default,
    // @ts-ignore
    "contracts/4_ERC20.sol": (
      await import("raw-loader!./contracts/4_ERC20.sol")
    ).default,
    // @ts-ignore
    ...
    "tests/Ballot_test.sol": (
      await import("raw-loader!./tests/Ballot_test.sol")
    ).default,
    // @ts-ignore
    "tests/storage.test.js": (
      await import("!!raw-loader!./tests/storage.test.js")
    ).default,
    // @ts-ignore
